<div class="posts index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $event['Event']['event_time']; ?>&nbsp;</td>
	...
	<tr>
		<td colspan="9" height="1" bgcolor="#f7f7f7"></td>
	</tr>
...
<?php endforeach; ?>
	...
	<div class="paging" style="width:100%;background-color:#f7f7f7;text-align:center;padding:10px 0px;">
...
<div class="actions">
	<h2><?php __('Actions'); ?></h2>
		<?php echo $this->Html->link(__('Add New Event', true), array('action' => 'add')); ?>	
</div>